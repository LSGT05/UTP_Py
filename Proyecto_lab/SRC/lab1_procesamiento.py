...
input_file = os.path.join(base_path, "Proyecto_lab/DATA/RAW/datos_sucios_250_v2.csv")
output_file = os.path.join(base_path, "Proyecto_lab/DATA/PROCESSED/Temperaturas_Procesado.csv")
kpi_file = os.path.join(base_path, "Proyecto_lab/DATA/PROCESSED/KPIs.txt")

# Crear carpetas si no existen
os.makedirs(os.path.join(base_path, "Proyecto_lab/DATA/RAW"), exist_ok=True)
os.makedirs(os.path.join(base_path, "Proyecto_lab/DATA/PROCESSED"), exist_ok=True)
